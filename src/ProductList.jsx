...
function ProductList({ onHomeClick }) {
    ...
    const [addedToCart, setAddedToCart] = useState([]); // State to track added products// State to control the visibility of the About Us page
    ...
    const getTotalCartQuantity = () => {
        return cart.reduce((total, item) => total + item.quantity, 0); // Calculate total quantity of items in the cart
    };
    ...
    const handleContinueShopping = (e) => {
        e.preventDefault();
        setShowCart(false); // Hide the cart and return to the product listing
    };
    ...
    <div className="tag">
        <a href="#" onClick={(e) => handlePlantsClick(e)} style={styleA}><h2 style={{ color: 'white' }}>Plants</h2></a>
    </div>
    ...
    <div className="tag">
        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
            ...
            <span className="cart-quantity">({getTotalCartQuantity()})</span>
        </a>
    </div>
